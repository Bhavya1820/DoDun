    ...
    <>
      <div className="Home">
        <div className="Home_image" data-aos="fade-right">
          <img
            src="https://ik.imagekit.io/jncw2kb8u/marvin-meyer-SYTO3xs06fU-unsplash.jpg?updatedAt=1738232729946"
            alt=""
          />
        </div>
        <div className="Home_content" data-aos="fade-left">
          ...
          <p className="P2">
            We believe every bussiness has a story worth telling, and our
            mission is to transform that story into a powwerful digital
            presence.
          </p>
